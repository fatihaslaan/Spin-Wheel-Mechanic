...
namespace Util
{
    public static class ObjectFinder
    {
        ...
        public static void FindObjectInChilderenWithType<T>(ref T objectToFind, Transform transform) where T : MonoBehaviour
        {
        ...
        public static void FindObjectInChilderenWithName<T>(ref T objectToFind, Transform transform, string name) where T : MonoBehaviour
        {
